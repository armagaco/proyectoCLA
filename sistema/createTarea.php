...
echo "<form method= 'POST' class='form-horizontal' action= 'newTarea.php' id='idcabeceratarea' title='idcabeceratarea' >";
     echo "<div class='form-group'>";
         echo "<label for='inputEmail' class='control-label col-xs-2'>Periodo:</label>";
         echo "<div class='col-xs-10'>";
             echo "<input name = 'Periodo' type='text' id= 'Periodo' class='form-control' placeholder='Periodo'>";
         echo "</div>";
     echo "</div>";
     echo "<div class='form-group'>";
         echo "<label for='inputEmail' class='control-label col-xs-2'>Fecha:</label>";
         echo "<div class='col-xs-10'>";
             echo "<input name = 'Fecha' type='text' id= 'Fecha' class='form-control' placeholder='Fecha'>";
         echo "</div>";
     echo "</div>";
     echo "<div class='form-group'>";
         echo "<label for='inputName' class='control-label col-xs-2'>Supervisor:</label>";
         echo "<div class='col-xs-10'>";
             echo "<input name = 'Supervisor' type='text' id= 'Supervisor' class='form-control' placeholder='Supervisor'>";
         echo "</div>";
     echo "</div>";
     echo "<div class='form-group'>";
         echo "<label for='inputEmail' class='control-label col-xs-2'>CultivoLote:</label>";
         echo "<div class='col-xs-10'>";
