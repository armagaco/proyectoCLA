...
echo"<div id='tabla'>";   
	echo "<div id='contenedor'>";
		...
		echo "<div id='columna2'><a href='readCargo.php'>Areas</div>";
		echo "<div id='columna3'><a href='readCultivo.php'>Lotes</div>";
		echo "<div id='columna4'><a href='readCultivo.php'>Cultivos por Lotes</div>";
		echo "</div>";
		echo "<div id='contenidos'>";
		...
		echo "<div id='columna4'><a href='readCultivo.php'>Empleados</div>";
		echo "</div>";
		echo "<div id='contenidos'>";
		echo "<div id='columna1'><a href='readGrupoLabor.php'>Grupos de Labores</div>";
		echo "<div id='columna2'><a href='readCultivo.php'>Cabecera de Tarifario</div>";
		echo "<div id='columna3'><a href='readCultivo.php'>Cabecera de SupervisiónDRON</div>";
		echo "<div id='columna4'><a href='readCultivo.php'>Cabecera de Tareas</div>";
		echo "</div>";
		echo "<div id='contenidos'>";
		echo "<div id='columna1'><a href='readDepartamento.php'>Departamentos</div>";
		echo "<div id='columna2'><a href='readCultivo.php'>Detalle de Tarifario</div>";
		echo "<div id='columna3'><a href='readCultivo.php'>Detalle de SupervisiónDRON</div>";
		echo "<div id='columna4'><a href='readCultivo.php'>Detalle de Tareas</div>";
		echo "</div>";
		echo "<div id='contenidos'>";
		echo "<div id='columna1'><a href='readDepartamento.php'>Cargos</div>";
